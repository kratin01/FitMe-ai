      ...
      <section className="relative z-10 py-24 flex-grow">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            {/* CORNER DECARATION */}
            <div className="absolute -top-6 left-0 w-40 h-40 border-l-2 border-t-2" />
            ...
            <div className="lg:col-span-7 space-y-8 relative">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div className="pt-2">
                  ...
                  <span className="text-primary"> Fitness Coaching</span>
                </div>
              </h1>
              ...
              <p className="text-xl text-muted-foreground w-2/3">
                Talk to your personal AI fitness coach and start transforming your body with custom meal and workout plans today.
              </p>
